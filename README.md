...
Data is stored in the shared PostgreSQL `catalog` schema (`catalog.document` JSONB table). Start Postgres from [sigma-pg](https://github.com/sigmatactical-org/sigma-pg):
