...
[![CI](https://github.com/sigmatactical-org/catalog/actions/workflows/ci.yml/badge.svg)](https://github.com/sigmatactical-org/catalog/actions/workflows/ci.yml)
...
```bash
cd sigma/it/catalog && cargo run -p sigma-catalog
